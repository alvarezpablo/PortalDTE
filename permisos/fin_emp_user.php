  ...
  <div class="page-shell">
    <div class="topbar">
      <div>
        ...
        <div class="topbar-meta">La asignaci&oacute;n de rol al usuario fue procesada y el flujo conserva su retorno original al listado administrativo.</div>
      </div>
      <div>
    ...
    <div class="panel">
      <div class="panel-body">
        <div class="success-card">
          ...
          <div class="success-text">Puede volver al listado anterior para seguir administrando relaciones de roles y usuarios.</div>
