...
<script>
  ...
  <input type="hidden" name="op" value="<?php echo $op; ?>">
	...
	<div class="screenTitle">
		...
		<tr>
			<td>Relaciona Roles con Usuarios </td>
			<td class="uplevel">
...
<table class="formFields" cellspacing="0" width="30%" align="center">
	...
	<tr>
      ...
      <td  width="90%" align="left">          
          <SELECT NAME="nCodEmp" size="1" onChange="location.href='<?php echo $_LINK_BASE; ?>permisos/add_perm_user.php?nCodEmp=' + this.options[this.selectedIndex].value + '&op=<?php echo $op; ?>';">
  <?php 
