...
<script>
 ...
 <body onLoad="_body_onload();" onUnload="_body_onunload();" id="mainCP" class="visibilityAdminMode">
  <form name="formIndex" action="permisos/pro_perm_user.php" method="post">
    ...
    <div class="page-shell">
      <div class="topbar">
        <div>
          <div class="topbar-eyebrow">Permisos / Roles</div>
          <h1 class="topbar-title">Relacionar roles con usuarios</h1>
          <div class="topbar-meta">Se conserva el selector de empresa, la selecci&oacute;n de usuario y rol, y el env&iacute;o hacia <strong>permisos/pro_perm_user.php</strong>.</div>
        </div>
        ...
        <div class="panel-body">
          <div class="row g-3 align-items-end">
            <div class="col-lg-8">
              ...
              <select name="nCodEmp" id="nCodEmp" class="form-select" onchange="location.href='<?php echo $_LINK_BASE; ?>permisos/add_perm_user.php?nCodEmp=' + this.options[this.selectedIndex].value + '&op=<?php echo rawurlencode($op); ?>';">
<?php 
...
?>
            ...
            <div class="col-lg-4">
              <div class="panel-note">Seleccione una empresa para actualizar el rol de un usuario dentro del flujo administrativo actual.</div>
            </div>
          </div>
...
<?php if($nCodEmp <> ""){ ?>
          <div class="selection-layout mt-4">
            <div class="selection-card">
              <div class="selection-title">Usuarios</div>
              <div class="selection-help">Seleccione el usuario al que desea asignar un rol.</div>
              <select name="TableColumnList" multiple="multiple" size="10" class="form-select selection-select">
<?php         
...
?>
            ...
            <div class="selection-card">
              ...
              <div class="selection-help">Seleccione el rol que quedar&aacute; asociado al usuario elegido.</div>
...
<?php } else { ?>
          <div class="empty-state mt-4">
            ...
            <div>Primero seleccione una empresa para elegir usuario y rol dentro de este flujo de permisos.</div>
          </div>
<?php } ?>
        </div>
