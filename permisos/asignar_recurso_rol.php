...
<script>
  ...
  <div class="screenTitle">
    ...
    <tr>
      <td>Relaciona Roles con Recursos</td>
      <td class="uplevel">
  ...
  <tr>
    <td  align="right"> <label for="fid-cname">Empresa:</label>&nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</td>
      ...
      <td  width="90%" align="left">          
          <SELECT NAME="nCodEmp" size="1" onChange="location.href='<?php echo $_LINK_BASE; ?>permisos/asignar_recurso_rol.php?nCodEmp=' + this.options[this.selectedIndex].value + '&op=<?php echo $op; ?>';">
  <?php 
...
<?php   
        ...
        while (!$result->EOF) {
          ...
          echo '<option value="' . $cod_recurso . '">' . $desc_recurso . '</option>';          
