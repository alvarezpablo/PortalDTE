...
<script>
	    ...
	    <div class="page-shell">
	      <div class="topbar">
	        <div>
	          ...
	          <h1 class="topbar-title">Agregar recurso a rol</h1>
	        ...
	        <div class="panel-body">
	          <div class="row g-3 align-items-end">
	            <div class="col-lg-8">
	              ...
	              <select name="nCodEmp" id="nCodEmp" class="form-select" onchange="location.href='<?php echo $_LINK_BASE; ?>permisos/add_recurso.php?nCodEmp=' + this.options[this.selectedIndex].value + '&op=<?php echo rawurlencode($op); ?>';">
	<?php 
	...
	?>
	            ...
	            <div class="col-lg-4">
	              <div class="panel-note">Seleccione una empresa para cargar recursos disponibles y asociarlos a un rol dentro del flujo actual.</div>
	            </div>
	          </div>
	...
	<?php         
	        ...
	        while (!$result->EOF) {
	          ...
	          echo '<option value="' . $cod_recurso . '">' . h($des_recurso) . '</option>';          
	...
	<?php } else { ?>
	          <div class="empty-state mt-4">
	            ...
	            <div>Primero seleccione una empresa para elegir los recursos y el rol dentro de este flujo de permisos.</div>
	          </div>
	<?php } ?>
	        </div>
