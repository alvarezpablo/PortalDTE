...
$sLinkActual = "factura/list_aceptado.php?nTipDoc=" . urlencode($nTipDocFiltro);
...
<head>
	...
	<title>DTE Aceptados - Portal DTE</title>
	...
	<style>
		body{background:#eef2f7;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#1f2937}.page-shell{max-width:1500px;margin:0 auto;padding:1rem}.page-hero{background:linear-gradient(135deg,#14532d 0%,#16a34a 100%);color:#fff;border-radius:18px;padding:1.5rem;box-shadow:0 14px 34px rgba(21,128,61,.18);margin-bottom:1.25rem}.hero-icon{width:56px;height:56px;border-radius:16px;background:rgba(255,255,255,.14);display:flex;align-items:center;justify-content:center;font-size:1.4rem}.hero-pills,.paging{display:flex;flex-wrap:wrap}.hero-pills{gap:.75rem}.hero-pill{background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.18);border-radius:999px;padding:.45rem .85rem;font-size:.82rem}.card{border:1px solid rgba(15,23,42,.06);border-radius:16px;box-shadow:0 10px 24px rgba(15,23,42,.08);overflow:hidden;margin-bottom:1rem}.card-header{background:#14532d;color:#fff;padding:.9rem 1rem}.card-header .small{color:rgba(255,255,255,.78)}.filter-summary{background:#f8fafc;border:1px dashed #cbd5e1;border-radius:14px;padding:.9rem 1rem}.filter-chip,.status-badge{display:inline-flex;align-items:center;gap:.35rem;border-radius:999px;font-size:.8rem}.filter-chip{padding:.35rem .75rem;background:#fff;border:1px solid #dbe7f3;color:#334155}.status-badge{padding:.38rem .75rem;font-weight:600}.status-accepted{background:#ecfdf3;color:#166534}.status-rejected{background:#fef2f2;color:#b91c1c}.status-neutral{background:#f8fafc;color:#475569}.table thead th{background:#14532d;color:#fff;white-space:nowrap;vertical-align:middle}.table thead th.table-active{background:#16a34a;color:#fff}.table tbody td{vertical-align:middle;font-size:.88rem}.table tbody tr:hover{background:#f8fbff}.sort-link{color:#fff;text-decoration:none}.sort-link:hover{color:#dcfce7}.doc-meta{color:#64748b;font-size:.78rem}.empty-state{padding:4rem 1rem;text-align:center;color:#6b7280}.empty-state i{font-size:3rem}.paging{gap:.45rem;align-items:center}.paging a,.paging span{display:inline-flex;align-items:center;justify-content:center;min-width:2rem;height:2rem;border:1px solid #d0d7e2;border-radius:999px;padding:0 .7rem;background:#fff;color:#0f172a;text-decoration:none;font-size:.85rem}.paging a:hover{background:#eff6ff;border-color:#93c5fd}#loaderContainer{position:fixed;inset:0;background:rgba(15,23,42,.3);z-index:1050}#loaderContainerWH{vertical-align:middle;text-align:center}#loader{display:inline-block;background:#fff;border-radius:14px;padding:1rem 1.25rem;box-shadow:0 12px 28px rgba(15,23,42,.18)}@media (max-width:767.98px){.page-shell{padding:.75rem}.page-hero{padding:1.1rem}}
	</style>
