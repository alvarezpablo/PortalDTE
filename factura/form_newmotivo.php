...
<head>
  ...
  <style>
    ...
    .popup-card{width:100%;max-width:700px;border:0;border-radius:18px;overflow:hidden;box-shadow:0 18px 40px rgba(15,23,42,.16)}
    ...
    <div class="card popup-card">
      <div class="popup-head">
        <div class="d-flex align-items-start gap-3">
          <div class="popup-icon"><i class="bi bi-chat-square-text"></i></div>
          <div>
            <h1 class="h4 mb-1">Categorizar DTE</h1>
            <p class="mb-0 opacity-75">Version popup simplificada, manteniendo acuse, respuesta comercial y envio al formulario padre.</p>
          </div>
        </div>
      </div>
