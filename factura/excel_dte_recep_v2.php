<?php 
	...
	if($_GET){
		...
		$objPHPExcel->getProperties()->setCreator("OpenB") // Nombre del autor
			->setLastModifiedBy("OpenB") //Ultimo usuario que lo modific�
			->setTitle("Reporte Excel DTE Recibidos") // Titulo
			->setSubject("Reporte Excel DTE Recibidos") //Asunto
			->setDescription("Reporte Excel DTE Recibidos") //Descripci�n
...
//		$titulosColumnas = array('Tipo', 'Folio', 'F.Emisi�n','F.Recepcion', 'Exento', 'Neto', 'IVA', 'Total', 'Rut', 'Receptor', 'Direcci�n', 'Comuna','Acuse','Comercial','Mercader�a');
		$titulosColumnas = array('Tipo', 'Folio', 'F.Emisi�n','F.Recepcion', 'Exento', 'Neto', 'IVA', 'Total', 'Rut', 'Receptor', 'Direcci�n', 'Comuna','Acuse','Comercial','Mercader�a','Msg.ERP');
