...
//-->
 ...
 <div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>factura/list_dte_recep_v2.php';">DTE</a> &gt; </div>
 <div class="screenTitle">
  <table width="100%" cellspacing="0">
  <tr>
   <td>Informaci&oacute;n de DTE :</td>
...
<br> <br> <br>
     <div class="commonButton" id="bid-ok" title="Aceptar" onClick="location.href='<?php echo $_LINK_BASE; ?>factura/list_dte_recep_v2.php';" onMouseOver="" onMouseOut=""><button name="bname_ok">Aceptar</button><span>Aceptar</span></div>
 <br>    <br> <br>
    </td></tr></table>
  </fieldset>
