...
<BODY id="mainCP" onLoad="cargar();" onUnLoad="cerrar();" class="visibilityAdminMode">
  ...
  <FORM name="_FFORM" METHOD=POST ACTION="">
	<TABLE >
		<TR>
			<td width="33%"><label for="fid-cname">Tipo Factura:</label></td>
			<td width="33%" nowrap> 
				<SELECT NAME="sTipFac">
					<option value="DELGIRO">Factura del Giro</option>
					<option value="ACTFIJO">Factura Activo Fijo</option>
					<option value="IVAUSOCOMUN">Factura IVA uso Com&uacute;n</option>
					<option value="IVANORECUPER">Factura IVA no Recuperable</option>
				</SELECT>
				<script>chListSelect(document._FFORM.sTipFac, "<?php echo $sTipFac; ?>");</script>
			</td>
		</TR>
		<TR>
			<td width="33%"><label for="fid-cname">Motivo:</label></td>

			<td width="33%" nowrap> 
				<SELECT NAME="nMotIvaNoRec">
					<option value="">Aplica a Iva no Recuperable</option>
					<option value="1">Operaciones no gravados o exentas.</option>
					<option value="2">Facturas fuera de plazo.</option>
					<option value="3">Gastos rechazados</option>
					<option value="4">Entregas gratuitas</option>
					<option value="9">Otros</option>
				</SELECT>
				<script>chListSelect(document._FFORM.nMotIvaNoRec, "<?php echo $nMotIvaNoRec; ?>");</script>
			</td>
		</TR>
