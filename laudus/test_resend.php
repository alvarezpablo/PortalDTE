...
?>
	...
	<h2>Reenviar Periodo <?php echo $anio . "-" . $mes; ?> </h2>
	<br>
...
*/
		...
		echo "<br><br><br><a href='test_resend.php' >Volver</a>";
	}
else{
?>
<!doctype html>
<html lang="en">
 ...
 <br>
  <h2>Reenviar Periodo a Duemint dte@duemint.com</h2>
	  <br><br>
	<form name="_FFORM" enctype="multipart/form-data" action="test_resend.php" method="get" onsubmit="desac();">
