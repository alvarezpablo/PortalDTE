  ...
  <div class="page-shell">
    <div class="page-hero">
      <div class="d-flex align-items-start gap-3">
        <div class="hero-icon"><i class="bi bi-person-check"></i></div>
        <div>
          <h1 class="h3 mb-2">Usuario guardado</h1>
          <p class="mb-0 opacity-75">Se mantiene la confirmacion final del modulo de usuarios y el retorno conservador al listado.</p>
        </div>
      </div>
    </div>

    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
      <div class="status-chip"><i class="bi bi-people"></i><a href="<?php echo h($_LINK_BASE . $returnHref); ?>" class="text-decoration-none">Usuarios</a></div>
    ...
    <div class="card">
      <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <div>
          ...
          <div class="small mt-1">Pantalla final conservadora luego de insertar, modificar o eliminar un usuario.</div>
        </div>
      ...
      <div class="card-body p-4 text-center">
        ...
        <p class="text-muted mb-4">La informacion del usuario <?php echo ($sIdUsuNew !== "" ? '<strong>' . h($sIdUsuNew) . '</strong>' : 'seleccionado'); ?> fue procesada correctamente.</p>
