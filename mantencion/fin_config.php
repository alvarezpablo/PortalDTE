...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>empresa/listempre.php';">Configuraci&oacute;n</a> &gt; </div>
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td>Configuraci&oacute;n</td>
			<td class="uplevel"><div class="commonButton" id="bid-up-level" title="Subir nivel" onClick="location.href='<?php echo $_LINK_BASE; ?>empresa/listempre.php';"><button name="bname_up_level" onClick="location.href='<?php echo $_LINK_BASE; ?>mantencion/list_config.php';">Subir nivel</button><span>Subir nivel</span></div></td>
		</tr>
		</table>
	</div>
