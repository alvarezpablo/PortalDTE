...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>mantencion/form_user_sii.php';">Rut SII</a> &gt; </div>
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td>Rut SII</td>
			<td class="uplevel"><div class="commonButton" id="bid-up-level" title="Subir nivel" onClick="location.href='<?php echo $_LINK_BASE; ?>mantencion/form_user_sii.php';"><button name="bname_up_level" onClick="location.href='<?php echo $_LINK_BASE; ?>mantencion/form_user_sii.php';">Subir nivel</button><span>Subir nivel</span></div></td>
		</tr>
		</table>
	</div>
	...
	<div class="formArea">
		<fieldset>
			<legend>Datos de Acceso al SII Actualizados </legend>
				<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td align="center">
<br>	<br>	<br>
					<div class="commonButton" id="bid-ok" title="Aceptar" onClick="location.href='<?php echo $_LINK_BASE; ?>mantencion/form_user_sii.php';" onMouseOver="" onMouseOut=""><button name="bname_ok">Aceptar</button><span>Aceptar</span></div>
	<br>				<br>	<br>
				</td></tr></table>
		</fieldset>
