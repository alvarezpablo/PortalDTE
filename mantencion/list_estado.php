...
//-->
	...
	<?php sTituloCabecera("Estado de Documentos por Empresas"); ?>
<?php  
	$hoy = date("d-m-Y");
		...
		<div class="listArea">
                        ...
                        <fieldset>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                                <td>
<h2><font color=red>**** No incluye los documentos emitidos el d&iacute;a de hoy <?php echo $hoy; ?><br>
**** No incluye Boletas</font></h2>
