...
$hoy = date("d-m-Y");
$conn = conn();
$sLinkActual = "mantencion/list_estado.php";
...
END as estado
from xmldte where tipo_docu not in (39,41) and est_xdte < 78 and fec_carg < CURRENT_DATE group by est_xdte ORDER BY est_xdte";
...
from xmldte where tipo_docu not in (39,41) and est_xdte < 78 and fec_carg < CURRENT_DATE group by rs, est_xdte ORDER BY rs, est_xdte";
...
<head>
    ...
    <title>Estado de Documentos - Portal DTE</title>
    ...
    <div class="page-shell">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-lg-7">
                    <div class="d-flex align-items-start gap-3">
                        <div class="hero-icon"><i class="bi bi-bar-chart-line"></i></div>
                        <div>
                            <h1 class="h3 mb-2">Estado de Documentos por Empresas</h1>
                            <p class="mb-0 opacity-75">Vista consolidada del estado de los documentos emitidos, manteniendo la consulta legacy y el alcance original del reporte.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="hero-pills justify-content-lg-end">
                        <span class="hero-pill"><i class="bi bi-calendar-event me-1"></i>Excluye documentos del d&iacute;a: <?php echo h($hoy); ?></span>
                        <span class="hero-pill"><i class="bi bi-receipt-cutoff me-1"></i>No incluye boletas</span>
                        <span class="hero-pill"><i class="bi bi-database-check me-1"></i>Consulta legacy preservada</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-warning border-0 shadow-sm d-flex align-items-start gap-3" role="alert">
            ...
            <div>
                ...
                <div>Este informe no incluye los documentos emitidos el d&iacute;a de hoy <strong><?php echo h($hoy); ?></strong> ni las boletas, igual que en la versi&oacute;n legacy.</div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                <div>
                    ...
                    <div class="small mt-1">Resumen general del volumen de documentos por estado.</div>
                </div>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="empty-state">
                                            ...
                                            <p class="mb-0">La consulta no devolvi&oacute; registros en este momento.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
        ...
        <div class="card">
            <div class="card-header d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
                <div>
                    ...
                    <div class="small mt-1">Desglose por empresa manteniendo el mismo origen de datos y criterio de agrupaci&oacute;n.</div>
                </div>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="empty-state">
                                            ...
                                            <p class="mb-0">La consulta no devolvi&oacute; filas para el desglose por empresa.</p>
                                        </div>
                                    </td>
                                </tr>
                            <?php endif; ?>
