...
<script>
  ...
  <input type="hidden" name="op" value="<?php echo $op; ?>">
	...
	<div class="screenTitle">
		...
		<tr>
			<td>Relaciona Empresa con Usuarios </td>
			<td class="uplevel">
...
<table class="formFields" cellspacing="0" width="30%" align="center">
	...
	<tr>
      ...
      <td  width="90%" align="left">          
          <SELECT NAME="nCodEmp" size="1" onChange="location.href='<?php echo $_LINK_BASE; ?>user_emp/add_emp_user.php?nCodEmp=' + this.options[this.selectedIndex].value + '&op=<?php echo $op; ?>';">
  <?php 
...
?>        
          ...
          <td align="center">
            <select name ="IndexColumnList[]" multiple ="multiple" size ="10" style ="width: 10em;" id ="IndexColumnList">
<?php 
            $sql = "    SELECT ";
            $sql .= "        U.cod_usu,  ";
            $sql .= "        U.id_usu  ";
            ...
            while (!$result->EOF) {
              $nCodEmp = trim($result->fields["cod_usu"]);          
              $sRsEmp = trim($result->fields["id_usu"]);    
