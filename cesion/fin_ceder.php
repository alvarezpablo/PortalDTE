<?php 
	...
	$sTitulo = "Documento Cedido";
	$sResumen = "Documento Cedido Exitosamente";
...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>cesion/list_ceder.php';">Carga de Libros</a> &gt; </div>
...
<?php
 ...
 ?>
					...
					<div class="commonButton" id="bid-ok" title="Aceptar" onClick="location.href='<?php echo $_LINK_BASE; ?>cesion/list_ceder.php';" onMouseOver="" onMouseOut=""><button name="bname_ok">Aceptar</button><span>Aceptar</span></div>
	<br>				<br>	<br>
				</td></tr></table>
		</fieldset>
