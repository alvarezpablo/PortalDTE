...
?>																												
				...
				?>						
								...
								if($nTipDoc == "33" || $nTipDoc == "34" || $nTipDoc == "46" || $nTipDoc == "52" || $nTipDoc == "110") { ?>
											<td><a href="<?php echo $_LINK_BASE; ?>dte/view_pdf.php?sUrlPdf=<?php echo urlencode($sUrlPdfCedible); ?>">Cedible</a></td>
								<?php	} 
										else 
...
if($nEstadoDte == "0" || $nEstadoDte == "1" || $nEstadoDte == "3" || $nEstadoDte == "77" ) { ?>
									<td class="select"><input type="checkbox" class="checkbox" name="del[]" value="<?php echo $nFolioDte . "|" . $nTipDoc; ?>"></td> 
								<?php	}	?>
								</tr>
