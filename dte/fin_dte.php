...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>dte/list_dte_v2.php';">DTE</a> &gt; </div>
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td>DTE</td>
			<td class="uplevel"><div class="commonButton" id="bid-up-level" title="Subir nivel" onClick="location.href='<?php echo $_LINK_BASE; ?>dte/list_dte_v2.php';"><button name="bname_up_level" onClick="location.href='<?php echo $_LINK_BASE; ?>dte/list_dte_v2.php';">Subir nivel</button><span>Subir nivel</span></div></td>
		</tr>
		</table>
	</div>
	...
	<div class="formArea">
		<fieldset>
			<legend>Operaci&oacute;n Realizada</legend>
...
?>
					<div class="commonButton" id="bid-ok" title="Aceptar" onClick="location.href='<?php echo $_LINK_BASE; ?>dte/list_dte_v2.php';" onMouseOver="" onMouseOut=""><button name="bname_ok">Aceptar</button><span>Aceptar</span></div>
	<br>				<br>	<br>
				</td></tr></table>
		</fieldset>
