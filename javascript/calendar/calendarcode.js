...
var img_close;
img_del=new Image();
img_del.src="javascript/calendar/images/cal_del_small.gif";
img_close=new Image();
img_close.src="javascript/calendar/images/cal_close_small.gif";
...
img_Date_UP.src="javascript/calendar/images/cal_date_up.gif";

img_Date_OVER=new Image();
img_Date_OVER.src="javascript/calendar/images/cal_date_over.gif";

img_Date_DOWN=new Image();
img_Date_DOWN.src="javascript/calendar/images/cal_date_down.gif";


/* AGREGADO POR MABRI */
var objCalendar;
function setObjCalendar(obj){
	objCalendar = obj;
}

/* FIN AGREGADO POR MABRI */
...
function changeDay(whatDay) {
	...
	objCalendar.value = padout(curDate.getDate()) + "/" + padout(curDate.getMonth()+1) + "/" + curDate.getFullYear();
