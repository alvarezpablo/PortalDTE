//---------------------------------------- navigation
var treeopened = null;
var idPorDefault = "";		// id por defult chequedo

function irOpcion(id, url){
	document.getElementById(id).className='nodeActive';
	if(idPorDefault != "" && idPorDefault != id)
		document.getElementById(idPorDefault).className='node';
	idPorDefault = id;
}
