...
//
   ...
   chdir($old_dir);
   include_once($this->Ini->path_aplicacao . "rep_est_dte_head_foot.php"); 
   ...
   $_SESSION['rep_est_dte']['Font_ttf'] = $this->Font_ttf;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("rep_est_dte", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['iframe_menu'])
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']))
   { 
       $this->total[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']['total']; 
       $tmp_pos = strpos($this->total[0], "##@@");
       if ($tmp_pos !== false)
       {
           $this->total[0] = substr($this->total[0], 0, $tmp_pos);
       }
       $this->codi_empr[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']['codi_empr']; 
       $tmp_pos = strpos($this->codi_empr[0], "##@@");
       if ($tmp_pos !== false)
       {
           $this->codi_empr[0] = substr($this->codi_empr[0], 0, $tmp_pos);
       }
       $this->tipo_docu[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']['tipo_docu']; 
       $tmp_pos = strpos($this->tipo_docu[0], "##@@");
       if ($tmp_pos !== false)
       {
           $this->tipo_docu[0] = substr($this->tipo_docu[0], 0, $tmp_pos);
       }
       $this->est_xdte[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['campos_busca']['est_xdte']; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_select'] = array(); 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_select']['2'] = 'asc'; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_select']['3'] = 'asc'; 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_ant']  = "2,3"; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['tot_geral'][1] ;  
   }
...
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq']; 
   $nmgp_select .= " group by 2,3,4,5"; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['rep_est_dte']['lig_edit'];
   }
...
// 
   ...
   {  
      $this->nm_grid_colunas = 0; 
      $nm_quant_linhas = 0;
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['rep_est_dte']['qt_col_grid']) 
      {  
   ...
   $this->Lookup->lookup_est_xdte($this->look_est_xdte[$this->nm_grid_colunas]); 
          ...
          $this->codi_empr[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->codi_empr[$this->nm_grid_colunas]);
          $this->Lookup->lookup_tipo_docu($this->tipo_docu[$this->nm_grid_colunas] , $this->tipo_docu[$this->nm_grid_colunas]) ; 
          $this->tipo_docu[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->tipo_docu[$this->nm_grid_colunas]);
          ...
          $this->est_xdte[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->est_xdte[$this->nm_grid_colunas]);
          ...
          $this->fech_carg[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->fech_carg[$this->nm_grid_colunas]);
          $_SESSION['rep_est_dte']['fech_carg'] = $this->fech_carg[$this->nm_grid_colunas];
          $_SESSION['rep_est_dte']['total'] = $this->total[$this->nm_grid_colunas];
          $_SESSION['rep_est_dte']['codi_empr'] = $this->codi_empr[$this->nm_grid_colunas];
          $_SESSION['rep_est_dte']['tipo_docu'] = $this->tipo_docu[$this->nm_grid_colunas];
          $_SESSION['rep_est_dte']['est_xdte'] = $this->est_xdte[$this->nm_grid_colunas];
          if ($Init_Pdf)
          {
              $this->Pdf_init();
              $this->Pdf->AddPage();
          ...
          if ($Current_num_page != $Save_num_page)
          {
            ...
            $cell_6 = array('posx' => 200, 'posy' => 10, 'data' => $this->SC_conv_utf8('Fecha DTE: '), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_7 = array('posx' => 250, 'posy' => 25, 'data' => $this->SC_conv_utf8('Total'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_8 = array('posx' => 4, 'posy' => 25, 'data' => $this->SC_conv_utf8('Empresa'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_9 = array('posx' => 90, 'posy' => 25, 'data' => $this->SC_conv_utf8('Tipo DTE'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_10 = array('posx' => 180, 'posy' => 25, 'data' => $this->SC_conv_utf8('Estado DTE'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_11 = array('posx' => 100, 'posy' => 10, 'data' => $this->SC_conv_utf8('Reporte Estado DTE'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
 ...
 {
     if ($this->Font_ttf && !NM_is_utf8($input))
     {
         $input = mb_convert_encoding($input, "UTF-8", $_SESSION['scriptcase']['charset']);
     }
     elseif (!$this->Font_ttf && $_SESSION['scriptcase']['charset'] == "UTF-8")
     {
