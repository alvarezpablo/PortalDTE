...
class Header_Footer extends PDF_Visibility
{
   ...
   function Header()
   {
            ...
            $cell_5 = array('posx' => 230, 'posy' => 10, 'data' => $_SESSION['rep_est_dte']['fech_carg'], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 12, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_total = array('posx' => 250, 'posy' => 0, 'data' => $_SESSION['rep_est_dte']['total'], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_codi_empr = array('posx' => 5, 'posy' => 0, 'data' => $_SESSION['rep_est_dte']['codi_empr'], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_tipo_docu = array('posx' => 80, 'posy' => 0, 'data' => $_SESSION['rep_est_dte']['tipo_docu'], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_est_xdte = array('posx' => 160, 'posy' => 0, 'data' => $_SESSION['rep_est_dte']['est_xdte'], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
   ...
   {
       if ($_SESSION['rep_est_dte']['Font_ttf'] && !NM_is_utf8($input))
       {
           $input = mb_convert_encoding($input, "UTF-8", $_SESSION['scriptcase']['charset']);
       }
       elseif (!$_SESSION['rep_est_dte']['Font_ttf'] && $_SESSION['scriptcase']['charset'] == "UTF-8")
       {
