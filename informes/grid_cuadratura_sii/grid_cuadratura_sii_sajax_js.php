  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_cuadratura_sii" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  ajax_field_list[0] = "tipo_dte";
  ajax_field_list[1] = "folio_dte";
  ajax_field_list[2] = "rut_emisor";
  ajax_field_list[3] = "fec_emision";
  ajax_field_list[4] = "fec_recep";

  var ajax_error_list = {
    "tipo_dte": {"label": "Tipo DTE ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "folio_dte": {"label": "Folio DTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "rut_emisor": {"label": "RUT Emisor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
