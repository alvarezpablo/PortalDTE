  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_public_v_dte" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  ajax_field_list[1] = "folio_dte";
  ajax_field_list[2] = "fec_emi_dte";
  ajax_field_list[3] = "fech_carg";
  ajax_field_list[4] = "est_xdte";
  ajax_field_list[5] = "rut_rec_dte";

  var ajax_error_list = {
    "tipo_docu": {"label": "Tipo DTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "folio_dte": {"label": "Folio Dte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fec_emi_dte": {"label": "Fecha Emisión", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fech_carg": {"label": "Fecha Carga", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "est_xdte": {"label": "Estado DTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "rut_rec_dte": {"label": "Rut Recep.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
