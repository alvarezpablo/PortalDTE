...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["WebDTE_____grid_public_v_dte"]))
   {
      unset($_SESSION['session_sec_aplicacao']["WebDTE_____grid_public_v_dte"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_v_dte']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_public_v_dte']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_public_v_dte']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_public_v_dte']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_public_v_dte']['sc_modal']);
