...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["WebDTE_____grid_dte_recep_sii"]))
   {
      unset($_SESSION['session_sec_aplicacao']["WebDTE_____grid_dte_recep_sii"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dte_recep_sii']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dte_recep_sii']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dte_recep_sii']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dte_recep_sii']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dte_recep_sii']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dte_recep_sii</TITLE>
