  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_dte_recep_sii" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  ajax_field_list[0] = "rut_emisor";
  ajax_field_list[1] = "folio_dte";
  ajax_field_list[2] = "fecha_emision";
  ...
  var ajax_error_list = {
    ...
    "fecha_emision": {"label": "Fecha Emision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
