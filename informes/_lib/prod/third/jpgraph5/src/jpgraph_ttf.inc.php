...
// Created:     2006-11-19
// Ver:         $Id: jpgraph_ttf.inc.php,v 1.6 2011-08-09 19:23:47 sergio Exp $
//
...
// NetMake
DEFINE("FF_GENTIUM",33);
DEFINE("FF_WT002",34);
DEFINE("FF_IPAG",35);
DEFINE("FF_COURPRO",36);
DEFINE("FF_SIMPO",37);
...
class TTF {
    ...
    function __construct() {
            ...
            */
            ...
            /* NetMake */
        FF_SIMPO        =>  array(FS_NORMAL        =>'simpo.ttf',
                                      FS_BOLD        =>'',
                                      FS_ITALIC        =>'',
                                      FS_BOLDITALIC        =>'' ),
        FF_GENTIUM      =>  array(FS_NORMAL        =>'GenR102.TTF',
                                      FS_BOLD        =>'',
                                      FS_ITALIC        =>'',
                                      FS_BOLDITALIC        =>'' ),
        FF_WT002        =>  array(FS_NORMAL        =>'wt002.ttf',
                                      FS_BOLD        =>'',
                                      FS_ITALIC        =>'',
                                      FS_BOLDITALIC        =>'' ),
        FF_IPAG         =>  array(FS_NORMAL        =>'ipag.ttf',
                                      FS_BOLD        =>'',
                                      FS_ITALIC        =>'',
                                      FS_BOLDITALIC        =>'' ),
        FF_COURPRO      =>  array(FS_NORMAL        =>'courpro.ttf',
                                      FS_BOLD        =>'',
                                      FS_ITALIC        =>'',
                                      FS_BOLDITALIC        =>'' ),
            );
