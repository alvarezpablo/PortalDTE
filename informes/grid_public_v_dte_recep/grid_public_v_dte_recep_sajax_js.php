  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_public_v_dte_recep" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_public_v_dte_recep_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_tipo_docu_cond = scAjaxGetFieldText("tipo_docu_cond");
    var var_tipo_docu = scAjaxGetFieldSelect("tipo_docu");
    var var_fact_ref_cond = scAjaxGetFieldText("fact_ref_cond");
    var var_fact_ref = scAjaxGetFieldText("fact_ref");
    var var_rut_emite_cond = scAjaxGetFieldText("rut_emite_cond");
    var var_rut_emite = scAjaxGetFieldText("rut_emite");
    var var_fec_emision_cond = scAjaxGetFieldText("fec_emision_cond");
    var var_fec_emision_dia = scAjaxGetFieldText("fec_emision_dia");
    var var_fec_emision_mes = scAjaxGetFieldText("fec_emision_mes");
    var var_fec_emision_ano = scAjaxGetFieldText("fec_emision_ano");
    var var_fec_emision_input_2_dia = scAjaxGetFieldText("fec_emision_input_2_dia");
    var var_fec_emision_input_2_mes = scAjaxGetFieldText("fec_emision_input_2_mes");
    var var_fec_emision_input_2_ano = scAjaxGetFieldText("fec_emision_input_2_ano");
    var var_fec_recep_cond = scAjaxGetFieldText("fec_recep_cond");
    var var_fec_recep_dia = scAjaxGetFieldText("fec_recep_dia");
    var var_fec_recep_mes = scAjaxGetFieldText("fec_recep_mes");
    var var_fec_recep_ano = scAjaxGetFieldText("fec_recep_ano");
    var var_fec_recep_input_2_dia = scAjaxGetFieldText("fec_recep_input_2_dia");
    var var_fec_recep_input_2_mes = scAjaxGetFieldText("fec_recep_input_2_mes");
    var var_fec_recep_input_2_ano = scAjaxGetFieldText("fec_recep_input_2_ano");
    ...
    x_grid_public_v_dte_recep_ajax_save_filter( var_tipo_docu_cond, var_tipo_docu, var_fact_ref_cond, var_fact_ref, var_rut_emite_cond, var_rut_emite, var_fec_emision_cond, var_fec_emision_dia, var_fec_emision_mes, var_fec_emision_ano, var_fec_emision_input_2_dia, var_fec_emision_input_2_mes, var_fec_emision_input_2_ano, var_fec_recep_cond, var_fec_recep_dia, var_fec_recep_mes, var_fec_recep_ano, var_fec_recep_input_2_dia, var_fec_recep_input_2_mes, var_fec_recep_input_2_ano, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_public_v_dte_recep_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_public_v_dte_recep_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_public_v_dte_recep_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_public_v_dte_recep_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_public_v_dte_recep_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_public_v_dte_recep_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    NM_cond = document.F1.fec_emision_cond.value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_fec_emision').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_fec_emision').style.display = 'none';
    }
    NM_cond = document.F1.fec_recep_cond.value;
    if (NM_cond == "bw")
    {
        document.getElementById('id_vis_fec_recep').style.display = '';
    }
    else
    {
        document.getElementById('id_vis_fec_recep').style.display = 'none';
    }
    scAjaxProcOff();
    scAjaxShowDebug();
  ...
  // ---------- delete_filter
  function grid_public_v_dte_recep_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_public_v_dte_recep_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_public_v_dte_recep_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_public_v_dte_recep_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "tipo_docu";
  ajax_field_list[1] = "fact_ref";
  ajax_field_list[2] = "rut_emite";
  ajax_field_list[3] = "fec_emision";
  ajax_field_list[4] = "fec_recep";

  var ajax_error_list = {
    "tipo_docu": {"label": "Tipo DTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fact_ref": {"label": "Folio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "rut_emite": {"label": "Rut Emisor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fec_emision": {"label": "Fec. Emision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fec_recep": {"label": "Fec. Recep", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
