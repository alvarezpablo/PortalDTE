...
class grid_public_v_dte_recep_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_public_v_dte_recep_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['prim_vez'] = "S";
      }
   ...
   function processa_ajax()
   {
      ...
      $tipo_docu_cond, $tipo_docu,
             $fact_ref_cond, $fact_ref,
             $rut_emite_cond, $rut_emite,
      ...
      if (isset($this->NM_ajax_info['param']['fact_ref_cond']))
      {
          $fact_ref_cond = $this->NM_ajax_info['param']['fact_ref_cond'];
      }
      if (isset($this->NM_ajax_info['param']['fact_ref']))
      {
          $fact_ref = $this->NM_ajax_info['param']['fact_ref'];
      }
      if (isset($this->NM_ajax_info['param']['rut_emite_cond']))
      {
          $rut_emite_cond = $this->NM_ajax_info['param']['rut_emite_cond'];
      }
      if (isset($this->NM_ajax_info['param']['rut_emite']))
      {
          $rut_emite = $this->NM_ajax_info['param']['rut_emite'];
      }
...
//-- ajax metodos ---
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_public_v_dte_recep_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_public_v_dte_recep_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_public_v_dte_recep_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_tipo_docu()
   {
      ...
      { 
         ...
         { 
            ...
            $cmp1 = grid_public_v_dte_recep_pack_protect_string($cmp1);
            $cmp2 = grid_public_v_dte_recep_pack_protect_string($cmp2);
      ...
      $sel_ret_ajax .= "       <OPTION value=\"\">" . grid_public_v_dte_recep_pack_protect_string('Seleccione Tipo DTE') . "</OPTION>\r\n";
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      else
      {
         ...
         $nome_sum = "\"public\".v_dte_recep.$nome";
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "grid_public_v_dte_recep.php";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['proc_res']) 
    {
?>
   parent.document.getElementById('nmsc_iframe_grid_public_v_dte_recep').contentWindow.nm_gp_submit_ajax('inicio', '');
<?php
    }
    else
    {
?>
   parent.document.getElementById('nmsc_iframe_grid_public_v_dte_recep').src = 'grid_public_v_dte_recep.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>';
<?php
    }
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
<HEAD>
 <TITLE>Consulta DTE Recibidos</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_public_v_dte_recep_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_public_v_dte_recep_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_public_v_dte_recep_do_ajax_delete_filter(pos);
 }
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_public_v_dte_recep.php" method="post" target="_self"> 
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tipo_docu = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['tipo_docu']; 
          $tipo_docu_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['tipo_docu_cond']; 
          $fact_ref = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fact_ref']; 
          $fact_ref_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fact_ref_cond']; 
          $rut_emite = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['rut_emite']; 
          $rut_emite_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['rut_emite_cond']; 
          $fec_emision_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_dia']; 
          $fec_emision_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_mes']; 
          $fec_emision_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_ano']; 
          $fec_emision_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_dia']; 
          $fec_emision_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_mes']; 
          $fec_emision_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_ano']; 
          $fec_emision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_cond']; 
          $fec_recep_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_dia']; 
          $fec_recep_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_mes']; 
          $fec_recep_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_ano']; 
          $fec_recep_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_dia']; 
          $fec_recep_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_mes']; 
          $fec_recep_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_ano']; 
          $fec_recep_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['NM_operador']; 
          if (strtoupper($fact_ref_cond) != "II" && strtoupper($fact_ref_cond) != "QP" && strtoupper($fact_ref_cond) != "NP" && strtoupper($fact_ref_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($fact_ref, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($fact_ref_cond) || empty($fact_ref_cond))
      {
         $fact_ref_cond = "eq";
      }
      if (!isset($rut_emite_cond) || empty($rut_emite_cond))
      {
         $rut_emite_cond = "eq";
      }
      ...
      if (!isset($rut_empresa_cond) || empty($rut_empresa_cond))
      {
         $rut_empresa_cond = "eq";
      }
      if (!isset($nom_emite_cond) || empty($nom_emite_cond))
      {
         $nom_emite_cond = "eq";
      }
      ...
      if (!isset($codi_empr_cond) || empty($codi_empr_cond))
      {
         $codi_empr_cond = "eq";
      }
      ...
      if (!isset($fact_ref) || $fact_ref == "")
      {
          $fact_ref = "";
      }
      if (isset($fact_ref) && !empty($fact_ref))
      {
         $tmp_pos = strpos($fact_ref, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fact_ref = substr($fact_ref, 0, $tmp_pos);
         }
      }
      if (!isset($rut_emite) || $rut_emite == "")
      {
          $rut_emite = "";
      }
      if (isset($rut_emite) && !empty($rut_emite))
      {
         $tmp_pos = strpos($rut_emite, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rut_emite = substr($rut_emite, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_public_v_dte_recep_help.txt"))
   {
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['fact_ref'])) ? $this->New_label['fact_ref'] : "Folio"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <INPUT type="hidden" name="fact_ref_cond" value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?>
 </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
 ...
 $nmgp_tab_label .= "fact_ref?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_fact_ref" name="fact_ref" value="<?php echo NM_encode_input($fact_ref) ?>" size=17 alt="{datatype: 'integer', maxLength: 17, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['rut_emite'])) ? $this->New_label['rut_emite'] : "Rut Emisor"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <INPUT type="hidden" name="rut_emite_cond" value="eq"><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?>
 </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
 ...
 $nmgp_tab_label .= "rut_emite?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_rut_emite" name="rut_emite" value="<?php echo NM_encode_input($rut_emite) ?>" size=50 alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<?php
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['opc_psq'] && !$this->aba_iframe)
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_public_v_dte_recep" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_public_v_dte_recep" scrolling="auto" src="grid_public_v_dte_recep.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>&script_case_session=<?php echo session_id() ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_public_v_dte_recep" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_public_v_dte_recep" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_public_v_dte_recep_pesq"  name="nm_iframe_grid_public_v_dte_recep_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_public_v_dte_recep_pesq";
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.fact_ref.value = "";
   document.F1.rut_emite.value = "";
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fec_emision_dia').bind('change', function() {sc_grid_public_v_dte_recep_valida_dia(this)});
    $('#SC_fec_emision_input_2_dia').bind('change', function() {sc_grid_public_v_dte_recep_valida_dia(this)});
    $('#SC_fec_emision_input_2_mes').bind('change', function() {sc_grid_public_v_dte_recep_valida_mes(this)});
    $('#SC_fec_emision_mes').bind('change', function() {sc_grid_public_v_dte_recep_valida_mes(this)});
    $('#SC_fec_recep_dia').bind('change', function() {sc_grid_public_v_dte_recep_valida_dia(this)});
    $('#SC_fec_recep_input_2_dia').bind('change', function() {sc_grid_public_v_dte_recep_valida_dia(this)});
    $('#SC_fec_recep_input_2_mes').bind('change', function() {sc_grid_public_v_dte_recep_valida_mes(this)});
    $('#SC_fec_recep_mes').bind('change', function() {sc_grid_public_v_dte_recep_valida_mes(this)});
 }
 function sc_grid_public_v_dte_recep_valida_dia(obj)
 {
 ...
 function sc_grid_public_v_dte_recep_valida_mes(obj)
 {
 ...
 function sc_grid_public_v_dte_recep_valida_hora(obj)
 {
 ...
 function sc_grid_public_v_dte_recep_valida_min(obj)
 {
 ...
 function sc_grid_public_v_dte_recep_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_grid_public_v_dte_recep_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_grid_public_v_dte_recep_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_grid_public_v_dte_recep_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_grid_public_v_dte_recep_valida_cic(obj);
     }
     else
     {
         return sc_grid_public_v_dte_recep_valida_cnpj(obj);
     }
 }
 function sc_grid_public_v_dte_recep_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "WebDTE/grid_public_v_dte_recep";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_public_v_dte_recep']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($fact_ref_cond != "in")
          {
              nm_limpa_numero($fact_ref, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $fact_ref);
              ...
              $fact_ref = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($tipo_docu_cond)) ? $tipo_docu_cond : ""; 
          $NM_str_filter .= "tipo_docu_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($tipo_docu)) ? $tipo_docu : ""; 
          $NM_str_filter .= "tipo_docu#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fact_ref_cond)) ? $fact_ref_cond : ""; 
          $NM_str_filter .= "fact_ref_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fact_ref)) ? $fact_ref : ""; 
          $NM_str_filter .= "fact_ref#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($rut_emite_cond)) ? $rut_emite_cond : ""; 
          $NM_str_filter .= "rut_emite_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($rut_emite)) ? $rut_emite : ""; 
          $NM_str_filter .= "rut_emite#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_cond)) ? $fec_emision_cond : ""; 
          $NM_str_filter .= "fec_emision_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_dia)) ? $fec_emision_dia : ""; 
          $NM_str_filter .= "fec_emision_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_mes)) ? $fec_emision_mes : ""; 
          $NM_str_filter .= "fec_emision_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_ano)) ? $fec_emision_ano : ""; 
          $NM_str_filter .= "fec_emision_ano#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_input_2_dia)) ? $fec_emision_input_2_dia : ""; 
          $NM_str_filter .= "fec_emision_input_2_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_input_2_mes)) ? $fec_emision_input_2_mes : ""; 
          $NM_str_filter .= "fec_emision_input_2_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_emision_input_2_ano)) ? $fec_emision_input_2_ano : ""; 
          $NM_str_filter .= "fec_emision_input_2_ano#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_cond)) ? $fec_recep_cond : ""; 
          $NM_str_filter .= "fec_recep_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_dia)) ? $fec_recep_dia : ""; 
          $NM_str_filter .= "fec_recep_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_mes)) ? $fec_recep_mes : ""; 
          $NM_str_filter .= "fec_recep_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_ano)) ? $fec_recep_ano : ""; 
          $NM_str_filter .= "fec_recep_ano#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_input_2_dia)) ? $fec_recep_input_2_dia : ""; 
          $NM_str_filter .= "fec_recep_input_2_dia#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_input_2_mes)) ? $fec_recep_input_2_mes : ""; 
          $NM_str_filter .= "fec_recep_input_2_mes#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($fec_recep_input_2_ano)) ? $fec_recep_input_2_ano : ""; 
          $NM_str_filter .= "fec_recep_input_2_ano#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_patch .= "grid_public_v_dte_recep/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_public_v_dte_recep']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['tipo_docu_cond'] = 'text';
      $tp_html['fact_ref_cond'] = 'text';
      $tp_html['rut_emite_cond'] = 'text';
      $tp_html['fec_emision_cond'] = 'text';
      $tp_html['fec_recep_cond'] = 'text';
      $tp_html['tipo_docu'] = 'select';
      $tp_html['fact_ref'] = 'text';
      $tp_html['rut_emite'] = 'text';
      $tp_html['fec_emision_dia'] = 'text';
      $tp_html['fec_emision_mes'] = 'text';
      $tp_html['fec_emision_ano'] = 'text';
      $tp_html['fec_emision_input_2_dia'] = 'text';
      $tp_html['fec_emision_input_2_mes'] = 'text';
      $tp_html['fec_emision_input_2_ano'] = 'text';
      $tp_html['fec_recep_dia'] = 'text';
      $tp_html['fec_recep_mes'] = 'text';
      $tp_html['fec_recep_ano'] = 'text';
      $tp_html['fec_recep_input_2_dia'] = 'text';
      $tp_html['fec_recep_input_2_mes'] = 'text';
      $tp_html['fec_recep_input_2_ano'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "fact_ref_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "fact_ref")
                  {
                      if (strtoupper($fact_ref_cond) != "II" && strtoupper($fact_ref_cond) != "QP" && strtoupper($fact_ref_cond) != "NP" && strtoupper($fact_ref_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_public_v_dte_recep_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_public_v_dte_recep_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   function trata_campos()
   {
      ...
      $fact_ref_cond_salva = $fact_ref_cond; 
      if (!isset($fact_ref_input_2) || $fact_ref_input_2 == "")
      {
          $fact_ref_input_2 = $fact_ref;
      }
      $rut_emite_cond_salva = $rut_emite_cond; 
      if (!isset($rut_emite_input_2) || $rut_emite_input_2 == "")
      {
          $rut_emite_input_2 = $rut_emite;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['tipo_docu'] = $tipo_docu; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['tipo_docu_cond'] = $tipo_docu_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fact_ref'] = $fact_ref; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fact_ref_cond'] = $fact_ref_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['rut_emite'] = $rut_emite; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['rut_emite_cond'] = $rut_emite_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_dia'] = $fec_emision_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_mes'] = $fec_emision_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_ano'] = $fec_emision_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_dia'] = $fec_emision_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_mes'] = $fec_emision_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2_ano'] = $fec_emision_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_cond'] = $fec_emision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_dia'] = $fec_recep_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_mes'] = $fec_recep_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_ano'] = $fec_recep_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_dia'] = $fec_recep_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_mes'] = $fec_recep_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2_ano'] = $fec_recep_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_cond'] = $fec_recep_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $tipo_docu;
      ...
      $this->cmp_formatado['fact_ref'] = $Conteudo;
      $Conteudo = $rut_emite;
      $this->cmp_formatado['rut_emite'] = $Conteudo;
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2'] = $Conteudo; 
      ...
      //----- $fact_ref
      if (isset($fact_ref) || $fact_ref_cond == "nu" || $fact_ref_cond == "nn")
      {
         $this->monta_condicao("fact_ref", $fact_ref_cond, $fact_ref, "", "fact_ref");
      }

      //----- $rut_emite
      if (isset($rut_emite) || $rut_emite_cond == "nu" || $rut_emite_cond == "nn")
      {
         $this->monta_condicao("rut_emite", $rut_emite_cond, $rut_emite, "", "rut_emite");
      }
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_emision_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']['fec_recep_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_public_v_dte_recep']['where_pesq_ant'] = $this->comando . $this->comando_fim;
