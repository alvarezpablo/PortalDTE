<?php
  ...
  $sRutEmp = rq("sRutEmp");
  $sDvEmp = rq("sDvEmp");
  $returnHref = "empresa/certificado.php";
...
<head>
  ...
  <title>Certificado - Portal DTE</title>
  ...
  <div class="page-shell">
    <div class="page-hero">
      <div class="d-flex align-items-start gap-3">
        ...
        <div>
          <h1 class="h3 mb-2">Certificado cargado</h1>
          <p class="mb-0 opacity-75">Se mantiene la confirmacion final y el retorno conservador a la administracion del certificado.</p>
        </div>
      </div>
    </div>
...
<?php } ?>
    ...
    <div class="card">
      <div class="card-header d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2">
        <div>
          <div class="fw-semibold"><i class="bi bi-check2-circle me-2"></i>Certificado cargado</div>
          <div class="small mt-1">Pantalla final conservadora luego de la carga del certificado digital.</div>
        </div>
      ...
      <div class="card-body p-4 text-center">
        ...
        <p class="text-muted mb-4">El certificado fue cargado correctamente<?php echo ($companyLabel !== "" ? ' para la empresa <strong>' . h($companyLabel) . '</strong>' : ''); ?>.</p>
        <div class="d-flex flex-column flex-sm-row justify-content-center gap-2">
          <a href="<?php echo h($_LINK_BASE . $returnHref); ?>" class="btn btn-primary"><i class="bi bi-arrow-left-circle me-1"></i>Volver al certificado</a>
