...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);" onClick="location.href='<?php echo $_LINK_BASE; ?>empresa/licencia.php';">Empresas</a> &gt; </div>
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td>Licencia Cargada</td>
	...
	<div class="formArea">
		<fieldset>
			<legend>Licencia Cargada</legend>
				<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td align="center">
<br>	<br>	<br>
					<div class="commonButton" id="bid-ok" title="Aceptar" onClick="location.href='<?php echo $_LINK_BASE; ?>empresa/licencia.php';" onMouseOver="" onMouseOut=""><button name="bname_ok">Aceptar</button><span>Aceptar</span></div>
	<br>				<br>	<br>
				</td></tr></table>
		</fieldset>
