<?php
  ...
  $currentFileLabel = trim($sPathCert);
...
<head>
  ...
  <title>Certificado Empresa - Portal DTE</title>
    ...
    <div class="page-shell">
      <div class="page-hero">
        <div class="d-flex align-items-start gap-3">
          <div class="hero-icon"><i class="bi bi-file-earmark-lock2"></i></div>
          <div>
            <h1 class="h3 mb-2">Certificado digital de empresa</h1>
            <p class="mb-0 opacity-75">Carga conservadora del certificado, manteniendo el flujo legacy hacia <strong>pro_cert.php</strong>.</p>
          </div>
        </div>
      </div>
...
<?php } ?>
      ...
      <div class="card">
        <div class="card-header d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-2">
          <div>
            <div class="fw-semibold"><i class="bi bi-shield-lock me-2"></i>Formulario de certificado</div>
            <div class="small mt-1">Se preservan <code>multipart/form-data</code>, campos hidden y mensajes <code>sMsgJs</code> del flujo original.</div>
          </div>
        ...
        <div class="card-body p-4">
          <div class="row g-4 align-items-start">
            <div class="col-lg-8">
              <div class="mb-3">
                <label for="sPathCert" class="form-label fw-semibold">Certificado digital <span class="text-danger">*</span></label>
                <input type="file" name="sPathCert" id="sPathCert" class="form-control" size="25">
              </div>
              <div class="mb-0">
                <label for="sClaveCert" class="form-label fw-semibold">Clave certificado <span class="text-danger">*</span></label>
                <input type="password" name="sClaveCert" id="sClaveCert" class="form-control" value="" size="25" maxlength="20">
                <div class="form-text">Ingrese la clave solo si desea cambiarla.</div>
              </div>
            </div>
            <div class="col-lg-4">
...
<?php if($currentFileLabel !== ""){ ?>
                <div class="small text-muted mb-2">Certificado registrado actualmente:</div>
                <div class="current-file"><?php echo h($currentFileLabel); ?></div>
<?php }else{ ?>
                <div class="small text-muted mb-0">No hay un certificado visible en esta consulta legacy para la empresa actual.</div>
<?php } ?>
              </div>
            </div>
          </div>
