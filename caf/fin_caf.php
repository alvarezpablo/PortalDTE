...
$returnHref = "caf/form_caf_v2.php";
?>
<!DOCTYPE html>
<html lang="es">
<head>
	<link rel="shortcut icon" href="/favicon.ico">
	<title>Carga de CAF - Portal DTE</title>
	...
	<style>
		...
		.page-shell{max-width:820px;margin:0 auto;padding:1rem}.confirm-card{border:0;border-radius:18px;box-shadow:0 18px 40px rgba(15,23,42,.12);overflow:hidden}
		.confirm-body{padding:2rem 1.5rem;background:#fff}.icon-wrap{width:74px;height:74px;border-radius:22px;background:linear-gradient(135deg,#198754 0%,#20c997 100%);color:#fff;display:flex;align-items:center;justify-content:center;font-size:2rem}
	...
	<div class="page-shell">
		<div class="confirm-card card mt-4">
			<div class="confirm-body text-center">
				<div class="icon-wrap mx-auto mb-3"><i class="bi bi-check2-circle"></i></div>
				<h1 class="h3 mb-2">Carga de CAF</h1>
				<p class="text-secondary mb-4">El archivo fue procesado y puede continuar con el flujo habitual de carga.</p>
				<div class="alert alert-success border-0 shadow-sm mb-4"><strong>Operacion completada.</strong> Se mantiene el retorno del proceso, pero ahora con una vista mas clara y compatible con ISO-8859-1.</div>
				<div class="d-flex flex-column flex-sm-row gap-2 justify-content-center">
					<a href="<?php echo h($returnHref); ?>" class="btn btn-primary"><i class="bi bi-arrow-left-circle me-2"></i>Volver a cargar CAF</a>
