...
//-->
	...
	<div class="pathbar"><a href="javascript:void(0);">Caf</a> &gt;</div>
	<div class="screenTitle">
		<table width="100%" cellspacing="0">
		<tr>
			<td>Carga de Caf (Factura Electr&oacute;nica):</td>
...
<legend>Formulario de Caf </legend>
<table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td>

<table class="formFields" cellspacing="0" width="100%">
	<tr>
		<td class="name"><label for="fid-cname">Archivo Caf:</label>&nbsp;*</td>
